...
public class TestExerciseLibraryPersistence {
    ...
    void testExtremeValues() {
        testExtremeValue(1, 1, Double.MIN_NORMAL, 0.0, "Min");
        testExtremeValue(Integer.MAX_VALUE, Integer.MAX_VALUE,
                Double.MAX_VALUE / Integer.MAX_VALUE,
                Double.MAX_VALUE / Integer.MAX_VALUE, "Max");
    }
    ...
    private void testExtremeValue(int sets, int reps, double timePerRep,
            double restTime, String prefix) {
        Exercise exercise = createStrengthExercise(
                prefix + " Exercise", sets, reps, timePerRep, restTime);
        ...
        Exercise loaded = newLibrary.getExercise(prefix + " Exercise");
        ...
        assertEquals(reps, info.get("reps"), TEST_PRECISION);
    }
}
